...
class Common_Model extends CI_Model {
	...
	function brand()
	{
		$array['Merek : Daihatsu'] 		= 'Merek : Daihatsu';
		$array['Merek : Honda'] 		= 'Merek : Honda';
		$array['Merek : Toyota'] 		= 'Merek : Toyota';
		$array['Merek : Suzuki'] 		= 'Merek : Suzuki';
		$array['Merek : Mitsubishi'] 	= 'Merek : Mitsubishi';
		$array['Merek : Nissan'] 		= 'Merek : Nissan';
		$array['Merek : Isuzu'] 		= 'Merek : Isuzu';
		$array['Merek : Jeep'] 			= 'Merek : Jeep';
		$array['Merek : Lexus'] 		= 'Merek : Lexus';
		$array['Merek : Wuling'] 		= 'Merek : Wuling';
