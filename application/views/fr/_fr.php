    ...
    <div class="portlet-body form">
        <form role="form" id="frm_fr" class="form-horizontal form-bordered form-row-stripped">
            <div class="form-body">
                ...
                <div class="form-group">
                    <label class="col-md-3 control-label">Merk Mobil</label>
                    <div class="col-md-9">
                        <div class="checkbox-list">
                        	<?php foreach($brand as $b) { ?>
                            <label class="checkbox-inline col-md-3" style="margin-left:0px; padding-left:0px">
                            <input type="checkbox" name="inp[brand][]" id="" value="<?= $b ?>"> <img src="cdn/icons/<?= htmlspecialchars(str_replace('Merek : ', '', $b)) ?>.png" height="75" alt="<?= str_replace('_', ' ', $b) ?>">
                            </label>
                            <?php } ?>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="checkbox-list">
                            ...
                            <?php } ?>
                            <span class="help-block">Jangan dicentang jika ingin memilih semua jenis Mobil</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <label for="inputEmail1" class="col-md-3 control-label" title="<?= $c ?>">
                    	<img src="cdn/icons/<?= $f ?>.png" width="40" height="40" alt="<?= $c ?>"> &nbsp; <?= str_replace('_', ' ', $f) ?>
                    </label>
                    <div class="col-md-9">
