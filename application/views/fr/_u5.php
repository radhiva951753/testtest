                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="checkbox-list">
                            ...
                            <input type="checkbox" name="inp[brand][]" id="" value="<?= $b ?>" <?= in_array($b, $result['pref']['brand']) ? 'checked="checked"' : '' ?>> <img src="cdn/icons/<?= htmlspecialchars(str_replace('Merek : ', '', $b)) ?>.png" height="75" alt="<?= $b ?>">
                            </label>
                            <?php } ?>
