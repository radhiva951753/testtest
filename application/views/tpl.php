	...
	<div class="page-header-top">
		<div class="container">
			...
			<div class="page-logo" style="width:400px">
				<a href="">
					<img style="width:90px; height:75px; margin: top 10px;" src="assets/global/img/Cari_Mobil.png"></img>
                </a>
			</div>
			<!-- END LOGO -->
		...
		<div class="container">
			...
			<div class="hor-menu ">
				...
				<ul class="nav navbar-nav">
					<li>
						<a href="javascript:u1()"><i class="fa fa-comments"></i> Kebutuhan Fungsional Mobil</a>
					</li>
                    <!-- <li>
